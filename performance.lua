...
function _M.labelUpdater(event)
    ...
    _M.text.text = " FPS ["..tostring(mFloor( 1000 / (curTime - prevTime))).."] TexMem ["..
            tostring(mFloor(sGetInfo('textureMemoryUsed') * 0.0001) * 0.01).. "MB] Used Mem [" ..
