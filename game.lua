...
function PosEnemy(lvl)
    ...
    if lvl == 1 then                            --10Fingers
        xpos={20.75,20.75,20.75,33.75,33.75,33.75,46.75,46.75,59.75,46.75,59.75,59.75,53.25,53.25,53.25,27.25,27.25,27.25,40.25,40.25,40.25,66.25,66.25,66.25,72.75,72.75,72.75,79.25,79.25,79.25}
        ypos={15,20,25,15,20,25,15,25,15,20,20,25,30,25,20,20,25,30,30,25,20,20,25,30,15,20,25,20,25,30}
        brickcolor={62,62,62,62,62,62,62,62,62,62,62,62,54,54,54,54,54,54,54,54,54,54,54,54,62,62,62,54,54,54}
    ...
    if lvl == 2 then                            --Key and rainbow
        xpos={49.75,33.75,66.25,24,11,76,89,24,11,37,50,63,76,89,7.75,92.25,50,50}
        ypos={30,30,30,30,30,30,30,10,10,10,10,10,10,10,25,25,40,45}
        brickcolor={22,21,21,14,14,14,14,4,17,6,3,7,12,2,23,24,19,15}
        bosslevel = false
        LevelBallpower = 200
        maxBallSpeed.x=600
        maxBallSpeed.y=700
    ...
    if lvl == 3 then                            --Firebird
        xpos =          { 11, 24, 37, 50, 63, 76, 89, 11, 24, 37, 50, 63, 76, 89, 50, 50, 37, 63,37,63}
        ypos =          { 30, 25, 25, 20, 25, 25, 30, 35, 35, 40, 45, 40, 35, 35, 30, 35, 30, 30,35,35}
        brickcolor =    {  4,  4,  5,  5,  5,  4,  4,  4,  6,  6,  6,  6,  6,  4, 14, 18, 14, 14,18,18}
    ...
    if lvl == 4 then                            -- Apple Logo 80s
        xpos={59.75,53.25,72.75,43.5,63,33.75,69.5,56.5,43.5,30.5,79.25,69.5,56.5,43.5,30.5,20.75,56.5,43.5,30.5,20.75,66.25,69.5,56.5,43.5,30.5,20.75,79.25,69.5,56.5,43.5,30.5,63,43.5}
        ypos={10,15,20,20,20,20,25,25,25,25,25,30,30,30,30,30,35,35,35,35,35,40,40,40,40,40,45,45,45,45,45,50,50}
        brickcolor={53,53,53,3,3,53,6,6,6,6,56,4,4,4,4,54,5,5,5,55,55,2,2,2,2,52,57,11,11,11,11,11,7}
        LevelBallpower = 200
        maxBallSpeed.x=600
        maxBallSpeed.y=700
    end 
    
    if lvl == 5 then                            -- Bumpers and a square
        xpos =          { 11, 24, 37, 50, 63, 76, 89, 11, 11, 11, 11, 11, 89, 89, 89, 89, 89, 37 ,50 ,63, 37, 63, 50}
        ypos =          { 20, 20, 20, 20, 20, 20, 20, 25, 30, 35, 40, 45, 25, 30, 35, 40, 45, 35 ,35 ,35, 50, 50, 50}
        brickcolor =    {  4,  4,  5,  5,  5,  4,  4,  4,  6,  6,  6,  8,  4,  6,  6,  6,  8, 15, 18, 15, 14, 14, 13}
        bosslevel = false
        LevelBallpower = 200
        maxBallSpeed.x=600
        maxBallSpeed.y=700
    ...
    if lvl == 6 then                            -- 
        xpos={50,66.25,33.75,89,76,49.75,24,11,50,40.25,59.75,33.75,66.25,30.5,69.5,82.5,17.5,7.75,92.25,11,24,37,50,63,76,89,11,89,33.75,66.25,72.75,37,63,50,14.25,20.75,79.25,85.75,92.25,89,92.25,7.75,27.25,7.75,14.25,20.75,27.25,17.25,33.75,66.25,72.75,72.75,79.25,85.75,92.25,72.75,92.25}
        ypos={45,45,45,20,20,20,20,20,50,50,50,50,50,25,25,25,25,25,25,10,10,10,10,10,10,10,15,15,20,20,40,55,55,55,45,45,40,40,40,45,35,45,45,50,50,50,50,40,40,40,55,50,50,50,50,45,30}
        brickcolor={19,21,21,13,13,22,13,13,14,24,23,21,21,18,18,13,13,21,21,9,10,1,3,1,10,9,12,12,24,23,21,13,13,13,55,55,21,21,21,19,21,55,55,57,61,57,61,22,23,24,23,23,57,61,57,21,21}
        LevelBallpower = 200
        maxBallSpeed.x=600
        maxBallSpeed.y=700
    end 
    
    if lvl == 7 then                            -- Pacman ghost
        xpos =          { 24,24,24,24,24,24,37,37,37,37,50,50,50,50,50,50,50,63,63,63,63,76,76,76,76,76,76}
        ypos =          { 25,30,35,40,45,50,20,25,35,40,20,25,30,35,40,45,50,20,25,35,40,25,30,35,40,45,50}
        brickcolor =    {  5, 5, 5, 4,13, 4, 5, 5, 4, 4, 5, 5, 4, 4, 6,13, 6, 4, 4, 6, 6, 6, 6, 6, 6, 13, 6}
    ...
    if lvl == 8 then                            -- Facebook (change?)
        xpos =          { 24, 24, 24, 24, 24, 24, 24, 24, 37, 37, 37, 37, 37, 37, 37, 37, 50, 50, 50, 50, 50, 50, 50, 50, 63, 63, 63, 63, 63, 63, 63, 63, 76, 76, 76, 76, 76, 76, 76, 76}
        ypos =          { 15, 20, 25, 30, 35, 40, 45, 50, 15, 20, 25, 30, 35, 40, 45, 50, 15, 20, 25, 30, 35, 40, 45, 50, 15, 20, 25, 30, 35, 40, 45, 50, 15, 20, 25, 30, 35, 40, 45, 50}
        brickcolor =    {  7,  7,  7,  7, 15,  7,  7,  7,  7, 15, 15, 15, 15, 15, 15, 15, 15,  7,  7,  7, 15,  7,  7,  7,  7, 15,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7,  7}
    ...
    if lvl == 9 then                            -- uglyface
        xpos =          {37, 50, 63, 24, 76, 37, 50, 63, 24, 24, 24, 76, 76, 76, 37, 50, 63, 37, 50, 63, 50, 37, 63, 37, 50, 63}
        ypos =          {50, 50, 50, 45, 45, 45, 45, 45, 40, 35, 30, 40, 35, 30, 40, 40, 40, 35, 35, 35, 30, 20, 20, 25, 25, 25}
        brickcolor =    { 8,  8,  8, 13, 13,  5,  5,  5, 13, 13, 13, 13, 13, 13,  8,  8,  8,  8,  1,  8,  1, 14, 14,  8,  8,  8}
        bosslevel = false
        LevelBallpower = 200
        maxBallSpeed.x=600
        maxBallSpeed.y=700
    ...
    if lvl == 10 then                           -- Cherry
        xpos =          { 37,50,63,24,37,50,63,76,11,24,37,50,63,76,89,11,24,37,50,63,76,89,11,24,37,50,63,76,89,11,24,37,50,63,76,89,24,37,50,63,76,37,50,63}
        ypos =          { 15,15,15,20,20,20,20,20,25,25,25,25,25,25,25,30,30,30,30,30,30,30,35,35,35,35,35,35,35,40,40,40,40,40,40,40,45,45,45,45,45,50,50,50}
        brickcolor =    { 16,16,16,16, 5, 5, 5,16,16, 5,15, 5, 5,17,16,16, 5,15, 5, 5,17,16,16, 5, 5, 5, 5,17,16,16, 5, 5, 5, 5,17,16,16,17,17,17,16,16,16,16}
    ...
    if lvl == 11 then                           -- 2 Keys 2 locks
        xpos={56.25,37,33.75,33.75,33.75,72.75,72.75,43.5,63,53.25,43.5,43.5,63,63,7.75,7.75,7.75,24,11,24,40.25,72.75,72.75,72.75,82.5,82.5,92.25,82.5,72.75,92.25,76,89,33.75,7.75,89}
        ypos=       {25,25,20,15,10,25,10,10,10,10,15,20,15,20,25,20,15,15,10,10,30,30,35,40,10,40,40,45,45,45,50,50,30,30,15}
        brickcolor= {22,13,21,21,21,21,21,13,13,21, 3, 6,17, 7,23,23,23,19,18,18,23,24,21,21,18,20,21,17,21,21,13,13,24,23,19}
        bosslevel = false
        LevelBallpower = 200
        maxBallSpeed.x=650
        maxBallSpeed.y=750
    ...
    if lvl == 12 then                           -- 1 key 1 lock 
        xpos={89,76,63,50,37,24,11,11,24,37,50,66.25,59.75,92.25,59.75,92.25,75.75,37,37,59.75,92.25,50,24,11,11,24,50}
        ypos={10,10,10,10,10,10,10,25,25,25,25,30,30,30,35,35,35,35,30,25,25,30,30,30,35,35,35}
        brickcolor={6,6,6,6,6,6,6,14,14,14,14,23,21,24,21,21,22,17,19,23,24,17,17,17,17,17,17}
        LevelBallpower = 200
        maxBallSpeed.x=650
        maxBallSpeed.y=750
    end
    ...
    if lvl == 14 then                           -- Androidlogo 
        xpos={11,24,37,50,63,76,89,76,63,50,37,24,50,11,89,30.5,69.5,14.25,20.75,85.75,79.25,79.25,56.5,43.5,20.75,69.5,56.5,43.5,30.5,30.5,69.5,59.75,82.5,17.5,40.25,89,76,63,50,37,24,11,49.75,69.5,82.5,30.5,17.5,7.75,92.25}
        ypos={37.5,37.5,37.5,37.5,37.5,37.5,37.5,32.5,32.5,32.5,32.5,32.5,27.5,32.5,32.5,22.5,22.5,10,15,10,15,22.5,22.5,22.5,22.5,17.5,17.5,17.5,17.5,27.5,27.5,27.5,27.5,27.5,27.5,47.5,47.5,47.5,47.5,47.5,47.5,47.5,42.5,42.5,42.5,42.5,42.5,42.5,42.5}
        brickcolor={3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,15,15,53,53,53,53,53,3,3,53,3,3,3,3,15,15,53,3,3,53,3,3,3,3,3,3,3,22,13,13,13,13,21,21}
        LevelBallpower = 200
        maxBallSpeed.x=650
        maxBallSpeed.y=750
    end 
    
    if lvl == 13 then                           -- 2 keys 2 locks hidden bricks
        xpos={82.25,66.25,66.25,66.25,66.25,66.25,56.5,43.5,30.5,33.75,27.25,24,11,27.25,27.25,7.75,11,33.75,72.75,79.25,85.75,92.25,72.75,79.25,85.75,79.25,85.75,92.25,92.25,72.75,92.25,79.25,85.75,72.75,50,33.75,33.75,17.5,49.75,11,20.75}
        ypos={25,25,30,35,40,45,45,45,45,25,40,25,25,35,30,50,32.5,20,45,45,45,45,40,35,30,40,35,30,35,35,40,30,40,30,35,15,10,15,25,40,40}
        brickcolor={22,21,23,23,23,23,13,13,13,21,21,13,13,21,21,23,19,21,55,56,53,57,57,57,57,55,55,55,56,53,53,53,56,56,8,66,66,19,22,16,66}
        LevelBallpower = 200
        maxBallSpeed.x=650
        maxBallSpeed.y=750
    end 
